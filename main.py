...
def killForWithSecret(program, secret):
        ...
        simgr = proj.factory.simgr(state)
        simgr.use_technique(angr.exploration_techniques.Veritesting(loop_unrolling_limit=256, enable_function_inlining=True))
        t1 = time.time()
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 2:
        ...
        killForWithSecret(sys.argv[1], int(sys.argv[2], 16))
